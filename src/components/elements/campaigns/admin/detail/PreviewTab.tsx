    ...
    <>
      ...
      <section className="container max-w-6xl mx-auto mt-6 p-2 sm:p-4">
        ...
        <p className="text-sm sm:text-base">
          Berikut adalah daftar kandidat yang berpartisipasi dalam campaign ini.
          Baca visi, misi, dan program kerja mereka sebelum memilih!
        </p>
        {/* CANDIDATES */}
                ...
                <p>
                  ...
                  {campaignData?.allowedEmails?.length <= 2
                    ...
                    : campaignData?.allowedEmails
                        ...
                        .join(", ")}
                  {campaignData?.allowedEmails?.length > 2 &&
                    ` and ${campaignData?.allowedEmails?.length - 2} more`}
      ...
      <section className="flex justify-center items-center bg-pimary-dpurple h-screen max-h-[220px] sm:max-h-[280px] my-4 sm:my-8">
        {campaignData ? (
          <CountdownDetail key={campaignData?.id} campaignData={campaignData} />
        ) : (
            ...
            <>
              <div
                className={`grid grid-cols-1 gap-6 justify-between border border-gray-300 rounded-3xl px-5 py-5 sm:py-10 sm:col-span-2 sm:grid-cols-${
                  campaignData && campaignData.candidates.length > 3
                    ? 3
                        ...
                        <div className="flex justify-center gap-2">
                          <p className="text-sm">
                            {`Candidate ${candidate.number} • ${
                              campaignData?.result?.[candidate.id]
                                ?.totalVotes || "0"
                            } Voters`}
                          </p>
                        </div>
        ...
        <div className="modal-box rounded-lg p-6">
          ...
          <div className="border border-gray-300 p-2 rounded-lg mb-2">
            ...
            <p className="text-gray-500 text-sm">
              Visi kami adalah menjadikan organisasi lebih modern, inklusif, dan
          ...
          <div className="border border-gray-300 p-2 rounded-lg mb-2">
            ...
            <ol className="text-gray-500 text-sm list-decimal ms-4">
              <li>
                Meningkatkan komunikasi antar anggota melalui platform digital.
              </li>
              <li>
                Menyelenggarakan pelatihan dan workshop rutin untuk pengembangan
                diri.
              </li>
          ...
          <div className="border border-gray-300 p-2 rounded-lg">
            <p className="text-gray-500 text-sm">{candidateDetail?.program}</p>
            <ol className="text-gray-500 text-sm list-decimal ms-4">
