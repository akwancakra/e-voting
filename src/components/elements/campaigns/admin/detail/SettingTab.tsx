...
const SettingTab: React.FC<SettingTabProps> = ({
  ...
  const handleRemoveEmailInput = (index: number) => {
    setIsEmailChanged(true);
    setAllowedEmails(allowedEmails.filter((_: any, i: number) => i !== index));
  };
  ...
  useEffect(() => {
    ...
    const timer: any = setInterval(() => {
      setTimeLefts(formatTimeLeft(calculateTimeLeft(campaignData?.expiredAt)));
    }, 1000);
    ...
    <>
      ...
      <section className="container max-w-6xl mx-auto">
        ...
        <div className="mt-5 border border-gray-300 rounded-lg p-4">
          <p className="tracking-tighter font-semibold">Allowed emails</p>
          <p className="text-gray-500 text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Consequuntur corporis modi placeat sit magni ullam laborum neque
            incidunt tempora doloremque? Velit qui voluptatibus laborum aliquam.
          </p>
              ...
              <div className="relative mb-2" key={index}>
                <label className="form-control w-full">
                  <input
                    ...
                    onChange={(e) => {
                      const updatedEmails = allowedEmails.map(
                        (emailData: any, i: number) => {
                          if (index === i) {
                            return {
                              ...emailData,
                      ...
                      handleAllowedEmailChange(updatedEmails);
                    }}
                    // onChange={(e) => {
        ...
        {/* FINISH CAMPAIGN */}
        <div className="mt-5 border border-gray-300 rounded-lg p-4">
          <p className="tracking-tighter font-semibold">Finish campaign</p>
          <p className="text-gray-500 text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Consequuntur corporis modi placeat sit magni ullam laborum neque
            incidunt tempora doloremque? Velit qui voluptatibus laborum aliquam.
          ...
          <div className="mt-3">
            ...
            <p className="font-semibold tracking-tighter text-lg sm:text-2xl">
              ...
              <span className="countdown">
                <span style={{ "--value": timeLefts.minutes } as any}></span>
              </span>
              :
              <span className="countdown">
                <span style={{ "--value": timeLefts.seconds } as any}></span>
              </span>
            </p>
          </div>
          <div className="mt-2 flex justify-end">
        ...
        {/* EDIT CAMPAIGN */}
        <div className="mt-5 border border-gray-300 rounded-lg p-4">
          <p className="tracking-tighter font-semibold">Edit Campaign</p>
          <p className="text-gray-500 text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Consequuntur corporis modi placeat sit magni ullam laborum neque
            incidunt tempora doloremque? Velit qui voluptatibus laborum aliquam.
        ...
        {/* DELETE CAMPAIGN */}
        <div className="mt-5 border border-gray-300 rounded-lg p-4">
          <p className="tracking-tighter font-semibold">Delete campaign</p>
          <p className="text-gray-500 text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Consequuntur corporis modi placeat sit magni ullam laborum neque
            incidunt tempora doloremque? Velit qui voluptatibus laborum aliquam.
          ...
          <div className="mt-2 flex justify-end">
            <button
              ...
              className={`btn text-white py-2 px-4 h-fit min-h-fit text-xs w-full sm:w-fit sm:text-sm ${
                isDisabled ? "btn-disabled cursor-not-allowed" : "btn-error"
              }`}
              onClick={() => {
                isDisabled ? () => {} : handlerCampaignDeleteModal();
              }}
              disabled={isDisabled}
            >
              Delete Campaign
