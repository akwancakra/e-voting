...
const CampaignPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Daftar Campaign | E-Voting</title>
      </Head>
      {/* HERO BANNER */}
      ...
      <section className="container max-w-6xl mx-auto p-4">
        ...
        <p className="text-sm text-gray-500 sm:text-base">
          Berikut adalah daftar campaign pemilihan yang sedang aktif. Pilih
          salah satu untuk melihat detail kandidat dan lakukan voting secara
          online!
        </p>
        ...
        {loadingData ? (
          ...
          <div className="mt-6 grid grid-cols-2 justify-center gap-2 mb-3 md:grid-cols-3">
            {data.campaigns.campaigns.map((campaign: any, index: number) => {
