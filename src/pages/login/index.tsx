    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center sm:bg-gray-100">
        <div className="container mx-auto bg-white px-4 py-16 sm:border-gray-300 sm:rounded-lg sm:border sm:w-96">
          ...
          {/* Tombol untuk demo akun */}
          <button
            className="btn btn-outline w-full border-gray-500 text-gray-500 px-3 py-2 min-h-[2.5rem] h-10 hover:bg-transparent hover:text-gray-700 mt-4"
            type="button"
            onClick={() => modalRef.current?.showModal()}
          >
            Lihat Data Akun Demo
          </button>
          {/* Modal akun demo */}
          <dialog ref={modalRef} className="modal modal-bottom sm:modal-middle">
            <div className="modal-box rounded-lg p-6">
              <h3 className="font-semibold tracking-tighter text-lg sm:text-xl mb-2">
                Akun Demo
              </h3>
              <div className="divider my-1" />
              <ul className="list-disc ms-4 text-sm">
                <li>
                  <b>Admin:</b> <br />
                  Email:{" "}
                  <span className="text-blue-600">admin@evoting.com</span>
                  <br />
                ...
                <li className="mt-2">
                  <b>Voter 1:</b> <br />
                  Email:{" "}
                  <span className="text-blue-600">voter1@evoting.com</span>
                  <br />
                  Password: <span className="text-blue-600">voter123</span>
                </li>
                <li className="mt-2">
                  <b>Voter 2:</b> <br />
                  Email:{" "}
                  <span className="text-blue-600">voter2@evoting.com</span>
                  <br />
                  Password: <span className="text-blue-600">voter123</span>
                </li>
              </ul>
